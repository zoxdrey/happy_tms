  ...
  render() {
    ...
    return (
      <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4 border-mixin">
        ...
        <h2 className="h5">
          Test-{this.state.testCaseId} :{this.state.testCaseTitle} - Version1
        </h2>
        <svg
        ...
        <div className="accordion accordion-flush" id="accordionFlushExample">
          <div className="accordion-item">
            <h2 className="accordion-header h5" id="flush-headingOne">
              <button
                className="accordion-button collapsed h5"
                type="button"
              ...
              <tr>
                ...
                <td>
                  <StepEditor
                    ...
                    value={this.state.testCaseSteps[0].step}
                  ></StepEditor>
                </td>
                <td>
                  <StepEditor
                    editState={this.state.editState}
                    value={this.state.testCaseSteps[0].expectedResult}
                  ></StepEditor>
                </td>
                <td>
                  <button
